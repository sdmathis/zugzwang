...
{
    if(uri.scheme() != QString("<coinname>"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("<coinname>://"))
    {
        uri.replace(0, 11, "<coinname>:");
    }
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("<coinname>-qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  <coinname>-qt [" + tr("command-line options") + "]                     " + "\n";
