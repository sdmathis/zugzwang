...
uint256 hashGenesisBlock("0x5dfd823f7cac6b228daeb1caddf50cf5f8e1506022d4368ae346a30e049d17f2");
...
const string strMessageMagic = "Zugzwang Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 60 * 60; // Zugzwang: readjust difficulty once per hour
static const int64 nTargetSpacing = 180; // Zugzwang: 3 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal zugzwang miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Zugzwang", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xfc3aaca62910cf35ce9a6d18d30cceadaaa906562fdf942784061b552754a5b3");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1412902910; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1231759;

        if (fTestNet)
        {
            block.nTime    = 1412882529;
            block.nNonce   = 4308184;
        }
